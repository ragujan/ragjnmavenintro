 ...
 * @author Acer
 */
public class GetIdSingle {

	String tbname;
	String colname;
	String value;

	public GetIdSingle(String tbname, String colname, String value) {
		this();
		this.tbname = tbname;
	...
	public static String getId(String tbname, String colname, String value) {
		...
		try {
			...
			Logger.getLogger(GetIdSingle.class.getName()).log(Level.SEVERE, null, ex);
