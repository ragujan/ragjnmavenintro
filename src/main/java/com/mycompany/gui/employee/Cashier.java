...
public class Cashier extends javax.swing.JFrame {
    ...
    public Cashier(EmployeeNavi en) {
        this();
        otherFramesInvolved = false;

    }
    public String empId;

    String loadTableQuery;
    String[] colnames = {"employee_id", "cashier_id", "employee_name"};
    ...
    private boolean empCheck() {
        ...
        ResultSet rs;
        try {
            rs = MySql.sq("SELECT * FROM `cashier` WHERE `employee_id`='" + empId + "'");
            if (rs.next()) {
                state = true;
            }
    ...
    private void addmanger() {
        if (textF1.getText().isEmpty()) {
            ...
            if (!empCheck()) {
                ...
                InsertTable it = new InsertTable("cashier", info);
                ...
                Message m = new Message(this, "This cashier Already exits ", "warning");
            }
        }
