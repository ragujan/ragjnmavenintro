 ...
 * @author Acer
 */
public abstract class DescriptionBox extends javax.swing.JDialog {

	/**
	 * Creates new form NewJDialog
	 */
	public DescriptionBox(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
	...
	public DescriptionBox(java.awt.Frame parent, String message) {
		this(parent, true);
		jLabel2.setText(message);
	}
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(DescriptionBox.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				DescriptionBox dialog = new DescriptionBox(new javax.swing.JFrame(), true) {
					@Override
